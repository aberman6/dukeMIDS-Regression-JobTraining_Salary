...
Ultimately, we selected the following model. The residuals of this model are normally distributed and fit our assumptions of linear regression (see Appendix Fig. 2 for residual plots).
...
Doesn't work for wealthy or older individuals
Outliers
